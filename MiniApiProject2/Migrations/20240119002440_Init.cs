...
namespace MiniApiProject2.Migrations
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "InterestUrlLinks",
                columns: table => new
                {
                    InterestUrlLinkId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InterestUrlLinks", x => x.InterestUrlLinkId);
                    table.ForeignKey(
                        name: "FK_InterestUrlLinks_Interests_InterestId",
                        column: x => x.InterestId,
                        principalTable: "Interests",
                        principalColumn: "InterestId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InterestUrlLinks_Persons_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Persons",
                        principalColumn: "PersonId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InterestUrlLinks_InterestId",
                table: "InterestUrlLinks",
                column: "InterestId");

            migrationBuilder.CreateIndex(
                name: "IX_InterestUrlLinks_PersonId",
                table: "InterestUrlLinks",
                column: "PersonId");
